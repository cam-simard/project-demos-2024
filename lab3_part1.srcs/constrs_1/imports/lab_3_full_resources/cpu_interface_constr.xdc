...
#------------------------------------------------------------------------
#-- Description : Constraint file for CPU. Program written in controller.vhd
#------------------------------------------------------------------------
...
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { change_output }]; #IO_L24N_T3_34 Sch=btn[1]
...
#set_property -dict { PACKAGE_PIN Y11   IOSTANDARD LVCMOS33 } [get_ports { output_state[0] }]; #IO_L18N_T2_13 Sch=led5_r
#set_property -dict { PACKAGE_PIN T5    IOSTANDARD LVCMOS33 } [get_ports { output_state[1] }]; #IO_L19P_T3_13 Sch=led5_g
#set_property -dict { PACKAGE_PIN Y12   IOSTANDARD LVCMOS33 } [get_ports { output_state[2] }]; #IO_L20P_T3_13 Sch=led5_b
